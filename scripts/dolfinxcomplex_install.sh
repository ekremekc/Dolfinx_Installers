python3 -m venv v042c
cd v042c && source bin/activate
...
cd xtl
cmake -G Ninja -DCMAKE_INSTALL_PREFIX=$CMAKE_INSTALL_PREFIX/xtl .
ninja install
...
export BASIX_VERSION=v0.4.2
export UFL_VERSION=2022.1.0
export FFCX_VERSION=v0.4.2
export DOLFINX_VERSION=v0.4.1
...
export xtensor_DIR=$CMAKE_INSTALL_PREFIX/xtl/lib/cmake/xtensor

git clone -b v0.4.1 --single-branch https://github.com/jorgensd/dolfinx_mpc.git
cd dolfinx_mpc 
mkdir -p build-dir 
